...
List<Project> projectList = [
  Project(
      ...
      'A real-time collaboration app where users can create or join teams, manage tasks across Backlog, In Review, and To-Do stages, and communicate via task-specific chat.',
      //'assets/images/cms1.png',
      'https://github.com/TanishaMehta17/Real-Time-Collaboration-Application'),
  Project(
    'Chatter Box',
  ...
  Project(
      ...
      'https://github.com/TanishaMehta17/Phytoscan'),
  Project(
